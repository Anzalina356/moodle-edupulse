...
class __Mustache_20479e6146ce73512d664cba252b3d25 extends Mustache_Template
{
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '    <select name="perpage" class="mt-1 form-select ignoredirty" id="';
...
';
        ...
        $buffer .= $this->sectionC3ed439b08328908e86252e5c2691575($context, $indent, $value);
...
';
    ...
    private function sectionC3ed439b08328908e86252e5c2691575(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('uniqid'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '-perpage\').addEventListener(\'change\', function(e) {
';
